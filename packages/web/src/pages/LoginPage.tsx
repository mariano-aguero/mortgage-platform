          ...
          {isLocalDevMode && (
            <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-4">
              ...
              <div className="space-y-1 text-xs text-amber-700">
                <p><strong>User:</strong> testuser@example.com / TestUser123!</p>
                <p><strong>Loan Officer:</strong> loanoffice@example.com / LoanOfficer123!</p>
                <p><strong>Admin:</strong> admin@example.com / AdminUser123!</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="hidden bg-brand-900 lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:px-12">
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mt-4 text-lg text-brand-200">
            Apply, track, and manage your mortgage applications with ease. Get faster approvals with
